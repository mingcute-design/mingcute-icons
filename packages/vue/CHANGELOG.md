...
- Expanded Vue installation, imports, props, accessibility, SSR,
...
- Vue components for Core Regular and Filled.
- Style barrels and direct icon subpath exports.
- Typed component props compatible with Vue 3.5 or newer.
