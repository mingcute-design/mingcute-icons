...
- Expanded SolidJS installation, imports, props, accessibility, SSR,
...
- SolidJS components for Core Regular and Filled.
- Style barrels and direct icon subpath exports.
- Typed component props compatible with SolidJS 1.9.x.
